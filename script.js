...
dob2.addEventListener("change", () => validateDOB(dob2));
function validateDOB(dob2){
let d2=dob2.value.split("-");
let year=d2[0];
let month=d2[1];
let date=d2[2];
...
if (age<18 || age>55) 
{
dob2.setCustomValidity("Your age is not between 18 , 55");
dob2.reportValidity();
}
else
{
dob2.setCustomValidity("");
}
}
